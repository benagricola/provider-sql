...
type RoleParameters struct {
	...
	// See https://www.mysql.org/docs/13/sql-createrole.html for available
	// privileges.
	// +optional
	Privileges []string `json:"privileges,omitempty"`

	// PasswordSecretRef references the secret that contains the password used
	// for this role. If no reference is given, the password will be set to 
	// NULL which will disable password login even if the LOGIN privilege is 
	// enabled.
	// +optional
...
// Roles can be thought of as either a 'User' or a 'Group' depending
